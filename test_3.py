...
with torch.no_grad():
    ...
    for frame_num, label in yolo_label_data.items():
        llm_input_bboxes[frame_num] = yolo_label_data[frame_num]
    ...
    if TEST:
        save_result_img(img_save_path, img_buffer, yolo_label_data, [], non_llm_input_bboxes, bboxes_list, sam_label)
